...
- (Optional) Configure the Subnet with custom configurations if needed. See the [ash.avalanche.subnet](/docs/toolkit/ansible-avalanche-collection/reference/roles/avalanche-subnet) reference doc for a list of all supported configuration keys.
