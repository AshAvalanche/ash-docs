...
| `avalanchego_custom_genesis_local_file`  | See [Genesis](https://docs.avax.network/nodes/configure/avalanchego-config-flags#genesis)                                                                                                                                                                             | `"{{ playbook_dir }}/files/genesis.json"`                          |
