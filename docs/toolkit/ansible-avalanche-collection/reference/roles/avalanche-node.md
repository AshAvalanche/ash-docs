...
| `subnet_txs_private_key`              | The private key used to sign the `addValidator` transactions.                                                                                                                                                                                                         | `PrivateKey-ewoqjP7PxY4yr3iLTpLisriqt94hdyDFNgchSxGGztUrTXtNN`                                         |
