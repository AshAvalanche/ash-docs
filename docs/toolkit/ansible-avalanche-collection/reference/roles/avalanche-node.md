...
| `avalanchego_vms_install`             | A dictionary of VMs to install on the node with their versions. The key is the VM nam and the value its version. See [VMs install](#vms-installation).                                                                                                                | `[]`                                                               |
...
| `avalanchego_chain_updrages`          | The list of upgrades of each chain. See [Network Upgrades](https://docs.avax.network/build/subnet/upgrade/customize-a-subnet#network-upgrades-enabledisable-precompiles).                                                                                             | `{}`                                                               |
